...
from nxpilot_ai.tools.registry import ToolRegistry
...
def _discover_tools() -> None:
    ...
    import nxpilot_ai.tools as tools_pkg
...
async def async_main() -> None:
    ...
    logger.info("NXPilot AI Server starting (stdio transport)")
